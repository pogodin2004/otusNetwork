...
<td>176</td>
 ...
 6. IPv4-адрес первого узла в этой подсети (1st):
   ...
   7. IPv4-адрес последнего узла в этой подсети (last):
         ...
         last = 192.135.250.182

   8. Широковещательный IPv4-адрес в этой подсети (brdcst):

         brdcst = 192.135.250.183
### Ответ 6:
<table>
<thead>
<tr>
...
<tr>
<td>Сетевой адрес этой подсети</td>
<td>192.132.250.176</td>
</tr>
<tr>
<td>IPv4-адрес первого узла в этой подсети</td>
<td>192.132.250.177</td>
</tr>
<tr>
<td>IPv4-адрес последнего узла в этой подсети</td>
<td>192.132.250.182</td>
</tr>
<tr>
<td>Широковещательный IPv4-адрес в этой подсети</td>
<td>192.132.250.183</td>
</tr>
</tbody>
</table>
...
```
Маска подсети нужна для определения границ подсетей. Благодаря маске можно узнать, какая часть IP-адреса узла сети относится к адресу сети, а какая — к адресу самого узла в этой сети
```