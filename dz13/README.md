...
```
2 физических интерефейса и VLAN. Активен интерфейс GigabitEthernet0/0/1ю
```
...
![](https://github.com/pogodin2004/otusNetwork/blob/main/dz13/images/11_sh_cdp_err.png)

   Сколько пакетов имеет выход CDP с момента последнего сброса счетчика?

```
В CPT не предусмотрены команды работы с пакетами ы CDP.
```
